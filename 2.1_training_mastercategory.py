...
cleaned_metadata_path = 'cleaned_metadata.csv'  # Ändere dies in deinen tatsächlichen Pfad
...
# Überprüfen und Entfernen von Klassen mit weniger als zwei Exemplaren
...
# Modell speichern
model_filename = 'clothing_classification_model.keras'
